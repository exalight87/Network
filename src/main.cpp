...
int main(int argc, char **argv)
{
    ...
    server.addRoute({.route = "api",
                     .subRoutes = {
                         ...
                         {.route = "2", .callable = [](const HttpRequest &request, HttpResponse &response) -> bool
                          {
                              HttpPage page;
                          ...
                          .subRoutes = {{.route = "test", .callable = [](const HttpRequest &request, HttpResponse &response) -> bool
                                         {
                                             HttpPage page;
